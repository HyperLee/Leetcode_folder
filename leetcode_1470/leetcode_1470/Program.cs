...
class Program
{
    ...
    /// Output: [2,3,5,4,1,7]
    /// Explanation: Since x1=2, x2=5, x3=1, y1=3, y2=4 and y3=7, the answer is [2,3,5,4,1,7].
    ///
    /// Example 2:
    ...
    ///
    /// 給定由 2n 個元素組成、形式為 [x1,x2,...,xn,y1,y2,...,yn] 的陣列 nums。
    /// 回傳形式為 [x1,y1,x2,y2,...,xn,yn] 的陣列。
    ///
    /// 範例 1：
    /// 輸入：nums = [2,5,1,3,4,7]，n = 3
    /// 輸出：[2,3,5,4,1,7]
    /// 解釋：因為 x1=2、x2=5、x3=1、y1=3、y2=4、y3=7，所以答案為 [2,3,5,4,1,7]。
    ///
    /// 範例 2：
